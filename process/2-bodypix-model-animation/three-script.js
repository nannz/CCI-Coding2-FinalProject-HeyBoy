...
function main(){
    ...
    var bodyMeshesGroup = new THREE.Group();
    {
        ...
        const body_mat = new THREE.MeshBasicMaterial({color: 0xffff00});
        for (let i = 0; i < 17; i++) {
    ...
    //add gltf through GLTFLoader for test
    {
        ...
        gltfLoader.load('assets/boy.glb', (gltf) => {
            ...
            console.log(jumpAnim);// idleAnima.tracks array
    ...
    //uncomment it to enable the mouse interaction with neck and waist.
    //when mousemove, the neck and waist starts rotate.
    ...
    function computeBodyPixDegree(_allPoses){
        // console.log(_allPoses.keypoints);
    ...
    function  triggerJump(_allPoses){
        //if 0-10 face and upperbody score > 0.8
        // && 9-10wrists.y < 0-nose.y
        //play Jump
        //allPoses.keypoints[i].score > 0.7
        //console.log(_allPoses.keypoints);
        nose =  _allPoses.keypoints[0].position;
    ...
    function render() {
        ...
        if(seg2three != null){
            ...
            /* show & update the bodyParts' meshes;
            for (let i = 0; i < 17; i ++){
